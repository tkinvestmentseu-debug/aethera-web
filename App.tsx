...
import { getResolvedTheme, syncAutoThemePalette, setActiveThemeMode } from './src/core/theme/tokens';
...
export default function App() {
  ...
  const statusStyle = resolvedTheme.background.startsWith('#F') ? 'dark' : 'light';
