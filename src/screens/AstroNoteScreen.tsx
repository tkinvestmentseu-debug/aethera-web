...
<View style={{ flex: 1, backgroundColor: currentTheme.background }}>
  <SafeAreaView style={{ flex: 1}} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={{ color: subColor, fontSize: 10, letterSpacing: 2 }}>{t('astroNote.notatki_astro', 'NOTATKI ASTRO')}</Text>
          <Text style={{ color: textColor, fontSize: 20, fontWeight: '700' }}>{t('astroNote.dziennik_nieba', 'Dziennik Nieba')}</Text>
        </View>
          ...
          {activeTab === 'write' && (
            <>
              ...
              <Animated.View entering={FadeInDown.duration(400)}>
                <Text style={{ color: subColor, fontSize: 11, letterSpacing: 1.5, marginBottom: 10, marginTop: 4 }}>{t('astroNote.typ_notatki', 'TYP NOTATKI')}</Text>
              ...
              <Animated.View entering={FadeInDown.delay(150).duration(400)}>
                <Text style={{ color: subColor, fontSize: 11, letterSpacing: 1.5, marginBottom: 8, marginTop: 16 }}>{t('astroNote.pytania_do_refleksji', 'PYTANIA DO REFLEKSJI')}</Text>
                  ...
                  <Animated.View entering={FadeIn.duration(400)}>
                    <View style={[styles.insightCard, { backgroundColor: ACCENT + '0C', borderColor: ACCENT + '30' }]}>
                      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 8 }}>
                        ...
                        <Text style={{ color: ACCENT, fontSize: 10, fontWeight: '700', letterSpacing: 1.5 }}>{t('astroNote.interpreta', 'INTERPRETACJA')}</Text>
                      </View>
              ...
              <Animated.View entering={FadeInDown.delay(250).duration(400)} style={{ marginTop: 16 }}>
                ...
                >
                  ...
                  <Text style={{ color: ACCENT2, fontSize: 14, fontWeight: '700' }}>{t('astroNote.zapisz_notatke', 'Zapisz notatkę')}</Text>
                </Pressable>
              </Animated.View>
            </>
          )}
            ...
            <>
              {astroNotes.length === 0 ? (
                <Animated.View entering={FadeInDown.duration(400)} style={[styles.emptyCard, { backgroundColor: cardBg, borderColor: cardBorder }]}>
                  ...
                  <Text style={{ color: textColor, fontSize: 16, fontWeight: '700', marginBottom: 6 }}>{t('astroNote.brak_notatek', 'Brak notatek')}</Text>
