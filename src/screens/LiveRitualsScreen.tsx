...
import {
  ...
  LayoutGrid, Radio, Archive, Waves, Sparkles, Sun, Heart, Music, Leaf,
...
const RITUALS_BASE = [
  {
    ...
    type: 'PORANEK',
    icon: Sun,
    color: TYPE_COLORS.PORANEK,
    live: true,
    desc: 'Obudź ciało i ducha o wschodzie słońca. Krótka praktyka oddechu, powitanie słońca i ustawienie intencji na cały dzień. Idealne na świeżym powietrzu lub przy otwartym oknie.',
    tips: [
      'Wstań 10 minut przed wschodem słońca',
      'Przygotuj szklankę ciepłej wody z cytryną',
      'Zanim otworzysz telefon — ustal trzy intencje dnia',
    ],
    element: 'Ogień',
    duration: 15,
    maxParticipants: 500,
  },
  {
    ...
    live: true,
    desc: 'Praca z energią ognia do głębokiego oczyszczania pola energetycznego. Spalamy wszystko, co zbędne — lęk, wstyd, stare wzorce. Jedna z najsilniejszych praktyk grupowych.',
    tips: [
  ...
  },
  {
    ...
    live: true,
    desc: 'Milczenie jako najgłębsza praktyka. Dołącz do setek ludzi siedzących razem w ciszy — energia zbiorowa amplifikuje każdą indywidualną sesję wielokrotnie.',
    tips: [
      'Stwórz ciche i przyciemnione miejsce do siedzenia',
      'Nie nastawiaj żadnych alarmów na czas sesji',
      'Po sesji zostań jeszcze kilka minut w spokoju przed wejściem w codzienność',
    ],
    element: 'Przestrzeń',
    duration: 20,
  ...
  },
  {
    ...
    live: false,
    desc: 'Otwieramy i balansujemy czakrę Anahata przez pranajamę, wizualizację zielonego światła i mantry. Praca z miłością bezwarunkową do siebie i innych.',
    tips: [
      'Usiądź wygodnie ze skrzyżowanymi nogami lub na krześle',
      'Połóż obie dłonie na centrum klatki piersiowej',
      'Przygotuj się na głębokie emocje — to znak uzdrawiania',
    ],
    element: 'Powietrze',
    duration: 35,
    maxParticipants: 200,
  ...
  {
    id: 'r5',
    title: 'Kąpiel Dźwiękowa — Misy Kryształowe',
    host: 'Dominika R.',
    participants: 178,
    type: 'WODA',
    icon: Waves,
    ...
    live: false,
    desc: 'Zanurzenie w harmonicznych falach dźwiękowych mis kryształowych i gongów tybetańskich. Rezonans 432 Hz harmonizuje całe pole energetyczne i odprowadza napięcia z ciała.',
    tips: [
      'Połóż się na macie lub w łóżku — wygoda jest kluczowa',
      'Używaj słuchawek stereo dla pełnego efektu przestrzennego',
      'Nie planuj żadnych aktywności przez godzinę po sesji',
    ],
    element: 'Woda',
    duration: 60,
    maxParticipants: 50,
  },
  {
    ...
    type: 'AFIRMACJE',
    icon: Sparkles,
    color: TYPE_COLORS.AFIRMACJE,
    live: false,
    desc: 'Grupowe recytowanie afirmacji obfitości w stanie głębokiej receptywności. Kiedy wiele umysłów skupia się na tym samym, rzeczywistość odpowiada. Praca z podświadomością przez powtarzanie.',
    tips: [
      'Przed sesją wypisz 3 rzeczy, za które jesteś wdzięczny/a',
      'Mów afirmacje głośno — wibracja dźwięku wzmacnia efekt',
      'Wizualizuj każdą afirmację jako już spełnioną rzeczywistość',
    ],
    element: 'Eter',
    duration: 25,
    maxParticipants: 300,
  },
  {
    ...
    live: false,
    desc: 'Celebracja pełni z intencjami wdzięczności i manifestacji. Pełnia to szczyt energii cyklu — czas zbierania plonów i ładowania kryształów. Wielka moc zbiorowej synchronizacji.',
    tips: [
      'Wyjdź na zewnątrz jeśli możesz, aby fizycznie zobaczyć księżyc',
      'Przygotuj kryształy lub przedmioty do ładowania w świetle księżyca',
  ...
  },
  {
    ...
    type: 'TANIEC',
    icon: Music,
    color: TYPE_COLORS.TANIEC,
    live: false,
    desc: 'Uwolnienie ciała przez spontaniczny, świadomy ruch przy rytmicznej muzyce. Bez choreografii, bez oceniania — tylko Twoje ciało i dźwięk. Doskonałe na uwolnienie emocji zatrzymanych w mięśniach.',
    tips: [
      'Zrób wolne miejsce wokół siebie — minimum 1,5m w każdą stronę',
      'Zacznij od powolnego ruchu i pozwól ciału przyspieszyć naturalnie',
      'Zamknij oczy gdy poczujesz się bezpiecznie — to wzmacnia doświadczenie',
    ],
    element: 'Ogień',
    duration: 40,
    maxParticipants: 80,
  },
  {
    ...
    type: 'INTENCJA',
    icon: Leaf,
    color: TYPE_COLORS.INTENCJA,
    live: false,
    desc: 'Naucz się prawidłowo oczyszczać przestrzeń życiową szałwią, palo santo i innymi ziołami. Rytuał grupowy ze wspólnym ustawieniem pola ochronnego wokół domu i bliskich.',
    tips: [
      'Przygotuj szałwię lub kadzidło wieczorem przed rytuałem',
      'Otwórz wszystkie okna i drzwi balkonowe przed rozpoczęciem',
      'Poruszaj się zgodnie z ruchem wskazówek zegara, zaczynając od wejścia',
    ],
    element: 'Ogień',
    duration: 25,
    maxParticipants: 50,
  },
  {
    ...
    type: 'UZDRAWIANIE',
    icon: Heart,
    color: TYPE_COLORS.UZDRAWIANIE,
    live: false,
    desc: 'Głęboka praca z tonem miłości 528 Hz, zwanym DNA Repair Frequency. Sesja skupia się na uzdrawianiu na poziomie komórkowym — fizycznym i emocjonalnym. Połączona z wizualizacją zielonego światła.',
    tips: [
      'Możesz siedzieć lub leżeć — ważne, by być w pełni komfortowo',
      'Połóż jedną dłoń na sercu, drugą na brzuchu',
      'Oddychaj spokojnie i wyobrażaj sobie zielone, uzdrawiające światło',
    ],
    element: 'Woda',
    duration: 40,
    maxParticipants: 200,
  },
  {
    ...
    color: TYPE_COLORS.CZAKRY,
    live: false,
    desc: 'Kompleksowy skan i harmonizacja wszystkich 7 czakr — od Muladhara do Sahasrara. Idealne na koniec dnia aktywnego — usuwa nagromadzoną energię obcą i resetuje pole do czystości.',
    tips: [
      'Przeprowadź krótki skan ciała przed sesją — zauważ gdzie czujesz napięcie',
      'Trzymaj w pobliżu czarne kryształy (obsydian, turmalin) do uziemienia',
      'Sesja może wywołać głęboki sen — to bardzo pożądany efekt',
    ],
    element: 'Ziemia',
    duration: 55,
    maxParticipants: 300,
  },
  {
    ...
    color: TYPE_COLORS.MEDYTACJA,
    live: false,
    desc: 'Kontemplacja nocnego nieba jako brama do wewnętrznej ciszy i astralnej projekcji. Prowadzona wizualizacja przez konstelacje — podróż do centrum własnej świadomości.',
    tips: [
      'Wyjdź na zewnątrz lub usiądź przy oknie z widokiem na niebo',
      'Znajdź jedną gwiazdę i skupiaj na niej wzrok przez pierwsze 5 minut',
      'Kiedy prowadzący poprosi — pozwól myślom odpłynąć jak chmury',
    ],
    element: 'Przestrzeń',
    duration: 35,
    maxParticipants: 500,
...
const FILTER_CHIPS = ['WSZYSTKIE', 'PORANEK', 'KSIĘŻYC', 'OGIEŃ', 'CZAKRY', 'MEDYTACJA', 'WODA', 'TANIEC', 'AFIRMACJE', 'UZDRAWIANIE', 'INTENCJA'];
...
function getIconName(type: string): string {
  const map: Record<string, string> = {
    ...
    PORANEK: 'Sun', TANIEC: 'Music', AFIRMACJE: 'Sparkles', INTENCJA: 'Leaf', UZDRAWIANIE: 'Heart',
  };
